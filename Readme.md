...
# Configuration Script – S-LG-XX - Rev. A

This **Configuration** script is designed for the **S-LG-XX** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – S-LG-XX Rev. A

Este script de **Configuration** está diseñado para el modelo **S-LG-XX** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
