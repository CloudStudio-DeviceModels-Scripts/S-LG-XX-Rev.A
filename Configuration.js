...
function getEndpoints(deviceAddress, endpoints) {
  ...
  var e = endpoints.addEndpoint("2", "Estado del parking", endpointType.genericSensor);
  e.variableTypeId = 1392;

  var e = endpoints.addEndpoint("3", "Tiempo de ocupación", endpointType.genericSensor);
